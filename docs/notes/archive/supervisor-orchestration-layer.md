...
**Related notes:** [phase11-master-session-bootstrap.md](./archive/phase11-master-session-bootstrap.md), [multi-model-roles.md](./multi-model-roles.md), [model-policy-layer.md](./model-policy-layer.md)
