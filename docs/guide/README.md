...
| T-06 | [The delegation pipeline](./tutorials/06-delegation-pipeline.md) — full `delegate_to_agent` flow, `delegation_pipeline` JSONL, config flags (context detail: T-04) | skeleton |
