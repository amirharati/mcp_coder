...
| 9 | P15-023 | [P15-023-idle-keepalive.md](../tasks/P15-023-idle-keepalive.md) | **pending** | Server-level idle keepalive — background asyncio task that keeps the MCP stdio pipe alive between tool calls, preventing inter-call disconnects. Fixes P15-ISS-023 (high). Epic 4 dogfood. |
