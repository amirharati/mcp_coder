...
| 12a | P15-031 | [P15-031-rg-exclude-dirs.md](../tasks/P15-031-rg-exclude-dirs.md) | **pending** | Fix rg symbol scan leaking `.next/` paths (B021 follow-up / P15-ISS-031) — add `_rg_exclude_globs()` to `_scan_symbol_rg()`. Safe to run **in parallel with P15-030**. |
