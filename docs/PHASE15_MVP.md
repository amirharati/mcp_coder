...
| 12d | P15-037/038 | [P15-037-038-create-section-and-action-softening.md](../tasks/P15-037-038-create-section-and-action-softening.md) | **pending** | `### Create` alias for `### Edit` (B026) + soften recommended_action when cross-workspace only (B025). Two tiny fixes, one session. |
