...
| 9 | P15-023 | *(spec pending)* | **pending** | Server-level idle keepalive — background asyncio task that keeps the MCP stdio pipe alive between tool calls, preventing inter-call disconnects. Fixes P15-ISS-023 (high). Epic 4 dogfood. |
