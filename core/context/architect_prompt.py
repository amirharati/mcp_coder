"""Architect pass prompt assembly (P4-020)."""
...
ARCHITECT_PREAMBLE = """## Role: architect planner

You produce a concise implementation plan for the executor brief.

Rules:
- Begin your response IMMEDIATELY with `## Architect plan` (no preamble).
...
def build_architect_pass_prompt(
    *,
    ...
    """Assemble architect pass prompt from spec + planner + picker context."""
    parts = [
        ARCHITECT_PREAMBLE,
