"""Architect pass enable flag (D-P4-18)."""
...
def architect_pass_enabled(workspace: str | Path) -> bool:
    """Default False. Env MCP_CODER_ARCHITECT_PASS=1 then yaml architect_pass: true."""
    return _resolve_flag(
        workspace,
        env_var="MCP_CODER_ARCHITECT_PASS",
        yaml_key="architect_pass",
        default=False,
    )
